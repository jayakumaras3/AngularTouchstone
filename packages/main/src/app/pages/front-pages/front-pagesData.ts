...
export const cardimgs: cardimgs[] = [
  ...
  },
  {
    id: 102,
    time: '4 mins Read',
    imgSrc: 'assets/images/blog/shutterstock_2631906525 [Converted]-01.jpg',
    user: 'assets/images/front-pages/user1.jpg',
    title: 'Diary of a Learning Manager that has it all together',
    subtitle: 'A week in the life',
    description: 'From Monday morning coffee to Thursday afternoon certificates — what a great week looks like with the right LMS.',
    views: '2,600',
    category: 'Learning & Development',
    comments: 4,
    date: 'Tue, Jun 10',
